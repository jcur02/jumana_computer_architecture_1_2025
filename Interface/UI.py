...
class UI:
    ...
    def create_figure(self):
        self.fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(15, 7))  
    ...
    def execute(self, event):
        ...
        InterpolatedImage = interpolate(selected_quadrant.tolist(), selected_quadrant.shape[0])

        self.ax3.imshow(InterpolatedImage, cmap=plt.get_cmap('gray'))
        self.fig.canvas.draw_idle()

        print('Interpolated Image shown')
